...
from ..nutrition_resolution import (
    ...
    quantity_display as _quantity_display,
    request_for_item as _request_for_item,
...
# Re-exported so existing importers of these names keep working. The definitions
# now live in ``bot.nutrition_resolution``; only ``resolve_catalog_diet_entry``
# below still belongs here, because it performs database lookups.
__all__ = [
    "ResolvedCatalogDietEntry",
    "food_command",
    "recipe_command",
